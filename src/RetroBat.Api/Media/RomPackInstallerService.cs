...
public sealed class RomPackInstallerService : IHostedService, IDisposable
{
    ...
    {
        hash = string.Empty;
        var logPath = Path.Combine(RetroBatPaths.PluginRoot, "logs", "package-installer", "rom-pack-installer.jsonl");
    ...
    private static string IndexPath => Path.Combine(RetroBatPaths.PluginRoot, "logs", "package-installer", "index.json");
    private static string PackageHashCachePath => Path.Combine(RetroBatPaths.PluginRoot, "logs", "package-installer", "package-hashes.json");
}
