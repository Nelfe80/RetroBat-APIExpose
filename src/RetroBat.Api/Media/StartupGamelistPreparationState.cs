...
public static class StartupGamelistPreparationLog
{
    ...
    public static async Task AppendAsync(string phase, string status, object details, CancellationToken cancellationToken)
    {
        try
        {
            var logPath = Path.Combine(RetroBatPaths.PluginRoot, "logs", "startup-gamelist-preparation.jsonl");
    ...
    public static object BuildStatus(int recentLogEntries)
    {
        ...
        return new
        {
            ...
            triggers = new
            {
                ...
                romPackIndex = DescribeFile(Path.Combine(RetroBatPaths.PluginRoot, "logs", "package-installer", "index.json")),
                collectionPackIndex = DescribeFile(Path.Combine(RetroBatPaths.PluginRoot, "logs", "package-installer", "collections-index.json")),
