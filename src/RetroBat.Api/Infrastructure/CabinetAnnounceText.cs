...
public static class CabinetAnnounceText
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Words = new()
    {
        ["fr"] = new()
        {
            ...
            ["replay_uncertain"] = "Lecture incertaine",
            ["replay_downloading"] = "Téléchargement du replay…",
            ["replay_download_percent"] = "Téléchargement {0} %",
            ["replay_download_eta"] = "encore {0} s",
            ["replay_download_size"] = "{0} Mo sur {1}",
            ["replay_this_core"] = "ce cœur",
            ["replay_core_other"] = "Ce record a été enregistré avec une autre version de {0}. La lecture peut s'interrompre avant la fin.",
        ...
        ["en"] = new()
        {
            ...
            ["replay_uncertain"] = "Uncertain playback",
            ["replay_downloading"] = "Downloading the replay…",
            ["replay_download_percent"] = "Downloading {0}%",
            ["replay_download_eta"] = "{0} s left",
            ["replay_download_size"] = "{0} MB of {1}",
            ["replay_this_core"] = "this core",
            ["replay_core_other"] = "This record was made with another version of {0}. Playback may stop before the end.",
        ...
        ["es"] = new()
        {
            ...
            ["replay_uncertain"] = "Reproducción incierta",
            ["replay_downloading"] = "Descargando la repetición…",
            ["replay_download_percent"] = "Descargando {0} %",
            ["replay_download_eta"] = "quedan {0} s",
            ["replay_download_size"] = "{0} MB de {1}",
            ["replay_this_core"] = "este núcleo",
            ["replay_core_other"] = "Este récord se grabó con otra versión de {0}. La reproducción puede detenerse antes del final.",
        ...
        ["ja"] = new()
        {
            ...
            ["replay_uncertain"] = "再生が不安定になる可能性",
            ["replay_downloading"] = "リプレイをダウンロード中…",
            ["replay_download_percent"] = "ダウンロード中 {0}%",
            ["replay_download_eta"] = "残り {0} 秒",
            ["replay_download_size"] = "{0} MB / {1}",
            ["replay_this_core"] = "このコア",
            ["replay_core_other"] = "この記録は別のバージョンの {0} で作成されました。最後まで再生できない場合があります。",
        ...
        ["zh"] = new()
        {
            ...
            ["replay_uncertain"] = "回放可能不稳定",
            ["replay_downloading"] = "正在下载回放…",
            ["replay_download_percent"] = "正在下载 {0}%",
            ["replay_download_eta"] = "还剩 {0} 秒",
            ["replay_download_size"] = "{0} MB / {1}",
            ["replay_this_core"] = "该核心",
            ["replay_core_other"] = "此记录是用另一个版本的 {0} 录制的。回放可能在结束前中断。",
        ...
        ["ko"] = new()
        {
            ...
            ["replay_uncertain"] = "재생이 불안정할 수 있음",
            ["replay_downloading"] = "리플레이 다운로드 중…",
            ["replay_download_percent"] = "다운로드 중 {0}%",
            ["replay_download_eta"] = "{0}초 남음",
            ["replay_download_size"] = "{0} MB / {1}",
            ["replay_this_core"] = "이 코어",
            ["replay_core_other"] = "이 기록은 다른 버전의 {0}(으)로 만들어졌습니다. 재생이 끝나기 전에 멈출 수 있습니다.",
